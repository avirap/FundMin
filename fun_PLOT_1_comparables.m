...
for b=1:B
    ...
    PLOT_bench_Annlzd(b)   = 100*(PLOT_bench(end,3,b)-1);
end
...
for b=1:B
color=[1/3*b,0*b,0*b];
                       text(DATES(end)+15,PLOT_bench_Return(end,b),{['\fontsize{12} $100','\fontsize{10.5} grew to \fontsize{12}$',num2str(PLOT_bench_Return(end,b)+100,3)]},'FontWeight','bold','HorizontalAlignment','left','VerticalAlignment','middle','color',color);
...
color=[103/255,142/255,47/255];
           ...
           text(DATES(end)+15,PLOT_main_Return(end),{['\fontsize{12} $100','\fontsize{10.5} grew to \fontsize{12}$',num2str(PLOT_main_Return(end)+100,3)];['\fontsize{12} ',num2str(PLOT_main_Annlzd,'%.1f'),'%','\fontsize{10.5} annualized']},'FontWeight','bold','HorizontalAlignment','left','VerticalAlignment','middle','color',color);
...
%%
title(TITLE,'color',[103/255,142/255,47/255],'Position', [DATES(1),Ymax,0],'horizontalAlignment', 'left','FontSize',14,'FontWeight','bold','FontName','Fredoka One');
